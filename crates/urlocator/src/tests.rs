...
fn url_matching_chars() {
    ...
    assert_eq!(max_len("\u{27E8}https://example.org\u{27E9}"), Some(19));
    assert_eq!(max_len("\u{27E9}https://example.org\u{27E8}"), Some(19));
}
...
#[test]
fn cjk_punctuation_excluded_from_url() {
    assert_eq!(max_len("https://example.org。"), Some(19));
    assert_eq!(max_len("https://example.org、"), Some(19));
    assert_eq!(max_len("https://example.org）"), Some(19));
    assert_eq!(max_len("https://example.org，"), Some(19));
