...
#[derive(Clone, Debug)]
pub struct OneKeySearchItem {
    pub credential: warp_onekey::OneKeyCredential,
}

impl SearchItem for OneKeySearchItem {
    ...
    fn accept_result(&self) -> OneKeySearchItemAction {
        OneKeySearchItemAction::SelectCredential(self.credential.clone())
    }

    fn execute_result(&self) -> OneKeySearchItemAction {
        self.accept_result()
    }
